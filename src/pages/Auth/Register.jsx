...
const Register = () => {
  ...
  useEffect(() => {
    document.title = "Warung Bibit | Register"
  }, [])
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await dispatch(setRegister({ ...formValue }))
            ...
            <Card className="shadow">
              ...
              <Card.Body>
                <div className="mb-3 mt-md-4">
                  ...
                  <p className=" mb-5">Lengkapi form dibawah untuk buat akun!</p>
                  <div className="mb-3">
                    <Form>
                      <Form.Group className="mb-3" controlId="nama">
                        ...
                        <Form.Control type="text" placeholder="cth. Sinta Puspito" onChange={(e) => setFormValue({ ...formValue, name: e.target.value })} />
                      </Form.Group>
                      ...
                      <div className="d-grid">
                        <Button disabled={loading} variant="success" type="submit" onClick={handleSubmit}>
